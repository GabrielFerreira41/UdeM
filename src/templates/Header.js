...
function Header() {
    return (
        <nav className="navbar navbar-expand-lg" style={{ background: "linear-gradient(to bottom, #121212, #181818)" }}>
            ...
            <img src={SpotAi} alt="Spot'Ai Logo" style={{ height: '60px', marginRight: '20px' }} />
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav ms-auto">
                    ...
                    <li className="nav-item">
                    <Link to="/my-ai" className="nav-link text-spotify-green" style={{ color: "#FFFFFF", fontWeight: "bold", fontSize: "18px" }} onMouseOver={e => e.currentTarget.style.opacity = 0.8} onMouseOut={e => e.currentTarget.style.opacity = 1}>🧠 My AI</Link>
                    </li>
                    <li className="nav-item">
